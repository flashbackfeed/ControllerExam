...
<%--         사용법 :-<c:set var="변수명" value="값" scope="page"></c:set>             -%>
<%--    jstl 표현식--%>
     <p><c:set var="num" value="10" scope="page"></c:set></p>
     <p><c:set var="num2" value="10" scope="page"></c:set></p>
     <p><c:set var="total" value="${num+num2}" scope="page"></c:set></p>
<%--  TODO : el 표현식--%>
    <p>${num}</p>
    <p>${num2}</p>
    <p>${total}</p>
...
<%--   TODO : 3) try ~ catch --%>
<%--    사용법 : <c:catch var="err"> 실행문 </c:catch>--%>
...
<%--   TODO 5) 공통 페이지 끼워넣기 : 머리말, 꼬리말--%>
<%--     사용법 : <c:import url="보여줄페이지"/>--%>
    <c:import url="footer.jsp"/>

<%--   TODO 6) url 로 페이지 이동하기--%>
<%--     사용법 : <c:url value="url 주소" var="변수명"/> --%>
<%--     사용 :<a href="${변수명}">네이버</a>--%>
...
<%--           chars 에 name 값 있으면 true, 없으면 false --%>
