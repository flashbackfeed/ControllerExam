 ...
 */
@Controller
// TODO : @RequestMapping("/공통url" : 공통 url 과 합쳐져서 사용됨
...
//    옵션 : defaultValue = "" : 쿼리스트링 변수의 값이 null 이면 "대체값" 바꿔줌
//          url 테스트 : localhost:8000/exam02/hello-name?name=홍길동
...
//                example01.jsp에 출력해 보세요
//                결과 : 부서명 : Sales
//         url 테스트 : localhost:8000/exam02/hello-dname?dname=Salse

    @GetMapping("/hello-dname")
    public String Part(Model model , @RequestParam(defaultValue = "") String dname){
    model.addAttribute("dname", "부서명 : " + dname);
    return "exam02/example01.jsp";
    }
// TODO : 연습 2) 숫자로 url 매개변수를 전달해서 화면에 출력해 보세요.
//           url : /exam02/hello-no
//           jsp : exmp02/example02.jsp
//            결과: 20
//         url 테스트 : http://localhost:8000/exam02/hello-no?no=20
    @GetMapping("/exam02/hello-no")
    public String Number(Model model , @RequestParam(defaultValue = "0") int no){
    model.addAttribute("no", "결과 : " + 20);
