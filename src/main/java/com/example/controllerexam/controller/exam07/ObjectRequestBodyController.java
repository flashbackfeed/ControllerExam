...
//          : D(Delete) : @DeleteMapping("url")
//    @RequestBody 객체명 : ( vs @ModelAttribute 객체명 : jsp 사용 )
    @PostMapping("/object-variable")
    public List<Member> getObjectRequestBody(@RequestBody Member member){
         List<Member> list = new ArrayList<>();
         list.add(member);
         return list;
    }
//  TODO : 연습 1) Qna 클래스를 만들어서 아래 데이터를 추가해서 REST Client 프로그램으로 출력해보세요.
//    입력 :
//           {
//               "no": 1,
//               "title": "제목"
...
//           },
//       ]
    @PostMapping("/Qna-info")
    public List<Qna> getQnaInfo(@RequestBody Qna qna){
...
//       ]
    ...
    public List<Board> getBoardInfo(@RequestBody Board board){
