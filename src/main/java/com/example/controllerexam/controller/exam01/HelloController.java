...
/**
 * packageName : com.example.controllerexam.controller.example01
 ...
 *                 1)  구조  => 소스가 분리됨
 *                 2) html 파일을 최초 1회 전송하고 다음부터는 변경되는 부분만 서버에서 받고
 *                    나머지는 웹 브라우저에서 자체 만듬
...
//     TODO : 해쉬맵 자료구조 (키, 값) => jsp 페이지로 변수(greeting, greeting2, ...)를 전송
...
//    TODO : 연습 1) url : /exam01/hello2 => "exam01/example01.jsp 에
//                                           "안녕 hello2 페이지" 출력하기
//                                           "Springboot 처음이지"
//                                           "수고해!!!"
    ...
    public String Hello2(Model model){
        model.addAttribute("hi", "안녕 hello2 페이지");
        model.addAttribute("hi2", "Springboot 처음이지");
        model.addAttribute("hi3", "수고해!!!");
        return "exam01/example01.jsp";
    }

//    TODO : 연습 2) url : /exam01/hello3 => "exam01/example02.jsp 에
//                                           "안녕 JSP 페이지야"
//                                           "JSP 에는 JSTL"
//                                           "EL 표현식이 있습니다."
...
//       결과        : boolean(bFlag),int(iParam),long(lParam),double(dParam) 변수 4개를
